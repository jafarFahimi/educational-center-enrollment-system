...
CREATE TABLE `enrollment` (
  ...
  `class_section_id` int(30) NOT NULL,
...
INSERT INTO `enrollment` (`id`, `student_id`, `school_year`, `class_section_id`, `teacher_id`, `status`, `date_updated`) VALUES
...
INSERT INTO `teacher` (`id`, `firstname`, `middlename`, `lastname`, `class_section_id`, `user_id`, `status`, `date_updated`) VALUES
(1, 'Jafar', '', 'Fahimi', 1, 4, 1, '2020-09-11 10:10:59');
...
INSERT INTO `class_section` (`id`, `class`, `section`, `status`, `date_updated`) VALUES
(1, 'Physics', 'A', 1, NULL),
(2, 'Maths', 'B', 1, NULL),
(3, 'Geometery', 'C', 1, NULL),
(4, 'English', 'A', 1, '2020-09-11 09:20:32');
...
(2, 'Jafar Fahimi', 1, 'jafarf', 'admin123', 1, '2020-09-08 16:13:53'),
(3, 'Sample User', 1, 'sample', 'sampl123', 1, '2020-09-09 11:34:14'),
(4, 'Jafar Fahimi', 2, 'jafarf', 'admin123', 1, '2020-09-11 09:55:25');
