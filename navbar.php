...
<nav id="sidebar" class='mx-lt-5 bg-light' style="background-color: #adadad !important;">
	<div class="container-fluid" style="padding: 0">
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=teacher" class="nav-item nav-teacher"><span class='icon-field'><i class="fa fa-user-tie"></i></span> Teacher</a>
				<a href="#settings-collapse" role="button" aria-expanded="false" aria-controls="settings-collapse" class="nav-item nav-class_section nav-school_year " data-toggle="collapse"><span class='icon-field'><i class="fa fa-scroll"></i></span> Academic <span class='float-right'><i class="fa fa-angle-down"></i></span> 
				</a>
